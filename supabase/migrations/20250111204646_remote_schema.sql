...
CREATE TABLE IF NOT EXISTS "public"."pages" (
    "id" bigint NOT NULL,
    "inserted_at" timestamp with time zone DEFAULT ("now"() AT TIME ZONE 'utc'::"text"),
    "slug" "text",
    "title" "text",
    "cover" "text",
    "nodes" "json",
...
ALTER TABLE ONLY "public"."pages"
    ADD CONSTRAINT "pages_created_by_fkey1" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id");
